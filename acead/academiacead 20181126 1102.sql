...
INSERT INTO `tbl_bitacora` (`Id_Bitacora`,`Fecha`,`Accion`,`Descripcion`,`Id_usuario`,`Id_Objeto`) VALUES 
 (1,'2018-11-10 00:00:00','Acceso','Accediendo al sistema',10,1),
 (2,'2018-11-10 10:05:33','Password','Modifica el password por correo',10,4),
 (3,'2018-11-26 16:23:04','Acceso al sistema','Accediendo al sistema por primera vez',19,1),
 (4,'2018-11-26 16:25:04','Acceso al sistema','Accediendo al sistema',19,1),
 (5,'2018-11-26 16:32:14','Acceso al sistema','Accediendo al sistema',19,1),
 (6,'2018-11-26 16:32:16','Salida','Cerrando la sesion en el sistema',19,7);
...
CREATE TABLE `tbl_clases` (
  ...
  KEY `fkIdx_Mod_Clase` (`Id_Modalidad`),
  CONSTRAINT `FK_Mod_Clase` FOREIGN KEY (`Id_Modalidad`) REFERENCES `tbl_modalidades` (`Id_Modalidad`)
...
CREATE TABLE `tbl_matricula` (
  ...
  KEY `fkIdx_Mod_Matricula` (`Id_Modalidad`),
  ...
  CONSTRAINT `FK_Mod_Matricula` FOREIGN KEY (`Id_Modalidad`) REFERENCES `tbl_modalidades` (`Id_Modalidad`),
...
INSERT INTO `tbl_objetos` (`Id_Objeto`,`Objeto`,`Descripcion`,`TipoObjeto`,`FechaCreacion`,`FechaModificacion`,`CreadoPor`,`ModificadoPor`) VALUES 
 (1,'Pantalla Login','Formulario de inicio de sesion','Pagina PHP','2018-11-25','2018-11-25','Admin','Admin'),
 (2,'Pantalla Preguntas','Formulario de preguntas de seguridad','Pagina PHP','2018-11-25','2018-11-25','Admin','Admin'),
 (3,'Pantalla repone contraseña','Formulario de envio de correo de recuperacion de contraseña','Pagina PHP','2018-11-25','2018-11-25','Admin','Admin'),
 (4,'Pantalla autoregistro','Formulario de registro de usuario','Pagina PHP','2018-11-25','2018-11-25','Admin','Admin'),
 (5,'Pantalla area trabajo','Pantalla de entorno de trabajo principal','Pagina PHP','2018-11-25','2018-11-25','Admin','Admin'),
 (6,'Pantalla cambio password','Formulario para cambiar el password del usuario','Pagina PHP','2018-11-25','2018-11-25','Admin','Admin'),
 (7,'Cierra sesion','Pagina de cierre de sesion','Pagina PHP','2018-11-25','2018-11-25','Admin','Admin');
...
INSERT INTO `tbl_personal` (`Id_Empleado`,`PrimerNombre`,`SegundoNombre`,`PrimerApellido`,`SegundoApellido`,`Telefono`,`Email`,`Cedula`,`CreadoPor`,`ModificadoPor`,`FechaCreacion`,`FechaModificacion`,`Id_Departamentos`,`Id_estadocivil`,`Id_genero`) VALUES 
 ...
 (20,'ALejandra','gabriela','cruz','mairena','33221122','rockowallaby@yahoo.com','803199523443','Autoregistro','AutoRegistro','2018-11-23','2018-11-23',1,1,1),
 (21,'Alan','leonardo','walker','suarez','99897856','alan@gmail.com','802199809987','Autoregistro','AutoRegistro','2018-11-26','2018-11-26',1,1,1);
...
INSERT INTO `tbl_preguntasusuario` (`Respuesta`,`Id_usuario`,`Id_Pregunta`,`FechaCreacion`,`FechaModificacion`,`CreadoPor`,`ModificadoPor`) VALUES 
 ...
 ('Rintin',18,1,'2018-11-23','2018-11-23','Autoregistro','Autoregistro'),
 ('Chilindrina',18,3,'2018-11-23','2018-11-23','Autoregistro','Autoregistro'),
 ('xavi',19,1,'2018-11-26','2018-11-26','Autoregistro','Autoregistro');
...
INSERT INTO `tbl_usuarios` (`Id_usuario`,`Usuario`,`Contrasena`,`FechaUltimaConex`,`PreguntasContestadas`,`PrimerIngreso`,`FechaVencimiento`,`CorreoElectronico`,`Id_Estado`,`Id_Rol`,`Id_Empleado`,`FechaCreacion`,`FechaModificacion`,`CreadoPor`,`ModificadoPor`,`code`) VALUES 
 ...
 (15,'silvita2','$2y$10$dXIDV2cPlF0.5TlArmxLx.LI4yXNJK0T0f7aETBhmsj7lNykJmo2G','2018-11-23 11:51:41',0,NULL,'2018-12-18','silvia@gmail.com',3,4,17,'2018-11-18','2018-11-18','Autoregistro',NULL,'k3v1pEulP'),
 (16,'mayra45','$d$dfdf45TFG455sfg&23A4','2018-11-24 20:31:01',0,NULL,'2018-12-19','mayra@gmail.com',3,4,18,'2018-11-19','2018-11-19','Autoregistro',NULL,'k3v1pEulP'),
 ...
 (18,'aleja2','$2y$10$99bFmQG9/GUkCDEJL4uYye8uiSvddimy3UvgJf2ODd8PERhpqFWjq','2018-11-25 11:37:27',0,NULL,'2018-12-23','rockowallaby@yahoo.com',3,4,20,'2018-11-23','2018-11-23','Autoregistro',NULL,'T4m8FuMl5'),
 (19,'alanw','$2y$10$U5ry1pNxhHOYDxFwd.F/lec3OtcDqJgp9ity0wT.H0l.6Qr2tKZpy','2018-11-26 10:23:15',0,NULL,'2018-12-26','alan@gmail.com',3,4,21,'2018-11-26','2018-11-26','Autoregistro',NULL,NULL);
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_addbitacora`(
  IN fecha_accion DATETIME,
  IN accn VARCHAR(20),
